...
func Test_PT_NumberOrdinal(t *testing.T) {
	assert.Equal(t, "zerésima", NumberOrdinal(PT, GENDER_FEMALE, 0))
	assert.Equal(t, "primeira", NumberOrdinal(PT, GENDER_FEMALE, 1))
	assert.Equal(t, "segunda", NumberOrdinal(PT, GENDER_FEMALE, 2))
	assert.Equal(t, "terceira", NumberOrdinal(PT, GENDER_FEMALE, 3))
	assert.Equal(t, "quarta", NumberOrdinal(PT, GENDER_FEMALE, 4))
	assert.Equal(t, "quinta", NumberOrdinal(PT, GENDER_FEMALE, 5))
	assert.Equal(t, "sexta", NumberOrdinal(PT, GENDER_FEMALE, 6))
	assert.Equal(t, "sétima", NumberOrdinal(PT, GENDER_FEMALE, 7))
	assert.Equal(t, "oitava", NumberOrdinal(PT, GENDER_FEMALE, 8))
	assert.Equal(t, "nona", NumberOrdinal(PT, GENDER_FEMALE, 9))
	assert.Equal(t, "décima", NumberOrdinal(PT, GENDER_FEMALE, 10))
	assert.Equal(t, "décima primeira", NumberOrdinal(PT, GENDER_FEMALE, 11))
	assert.Equal(t, "décima segunda", NumberOrdinal(PT, GENDER_FEMALE, 12))
	assert.Equal(t, "décima terceira", NumberOrdinal(PT, GENDER_FEMALE, 13))
	assert.Equal(t, "vigésima", NumberOrdinal(PT, GENDER_FEMALE, 20))
	assert.Equal(t, "trigésima", NumberOrdinal(PT, GENDER_FEMALE, 30))
	assert.Equal(t, "quadragésimo", NumberOrdinal(PT, GENDER_MALE, 40))
	assert.Equal(t, "quinquagésimo", NumberOrdinal(PT, GENDER_MALE, 50))
	assert.Equal(t, "sexagésimo", NumberOrdinal(PT, GENDER_MALE, 60))
	assert.Equal(t, "septuagésimo", NumberOrdinal(PT, GENDER_MALE, 70))
	assert.Equal(t, "octogésimo", NumberOrdinal(PT, GENDER_MALE, 80))
	assert.Equal(t, "nonagésimo", NumberOrdinal(PT, GENDER_MALE, 90))
	assert.Equal(t, "centésimo", NumberOrdinal(PT, GENDER_MALE, 100))
	assert.Equal(t, "centésimx vigésimx terceirx", NumberOrdinal(PT, GENDER_NON_BINARY, 123))
	assert.Equal(t, "ducentésimo", NumberOrdinal(PT, GENDER_MALE, 200))
	assert.Equal(t, "tricentésimo", NumberOrdinal(PT, GENDER_MALE, 300))
	assert.Equal(t, "quadringentésimo", NumberOrdinal(PT, GENDER_MALE, 400))
	assert.Equal(t, "quingentésimo", NumberOrdinal(PT, GENDER_MALE, 500))
	assert.Equal(t, "sexcentésimo", NumberOrdinal(PT, GENDER_MALE, 600))
	assert.Equal(t, "septingentésimo", NumberOrdinal(PT, GENDER_MALE, 700))
	assert.Equal(t, "octingentésimo", NumberOrdinal(PT, GENDER_MALE, 800))
	assert.Equal(t, "noningentésimo", NumberOrdinal(PT, GENDER_MALE, 900))
	assert.Equal(t, "milésimo", NumberOrdinal(PT, GENDER_MALE, 1000))
	assert.Equal(t, "décimo milésimo", NumberOrdinal(PT, GENDER_MALE, 10000))
	assert.Equal(t, "centésimo milésimo", NumberOrdinal(PT, GENDER_MALE, 100000))
	assert.Equal(t, "milionésimo", NumberOrdinal(PT, GENDER_MALE, 1000000))
	assert.Equal(t, "bilionésimo", NumberOrdinal(PT, GENDER_MALE, 1000000000))
	assert.Equal(t, "trilionésimo", NumberOrdinal(PT, GENDER_MALE, 1000000000000))
}
